...
router.get('/getads', async (req, res) => {
    ...
    const orderByClause = hasDateRange 
        ? (fulltextUsed ? 'ORDER BY startDate ASC, score DESC' : 'ORDER BY startDate ASC')
        : (fulltextUsed ? 'ORDER BY score DESC, id DESC' : 'ORDER BY id DESC');
    ...
    db.query(countQuery, params, (err, countResult) => {
        ...
        // ORDER BY id ASC per requirement example in special flow (safe to apply in all cases)
